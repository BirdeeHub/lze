...
test("handlers.on_plugin dep_of loads after before and before load", function()
    ...
    ok(true == plugin_state[tpl.name].load_called, "tpl load_called")
    ok(true == plugin_state[tpl.name].before_called, "tpl before_called")
    ok(true == plugin_state[tpl.name].after_called, "tpl after_called")
    ...
    ok(true == plugin_state[tpl_2.name].load_called, "tpl_2 load_called")
    ok(true == plugin_state[tpl_2.name].before_called, "tpl_2 before_called")
    ok(true == plugin_state[tpl_2.name].after_called, "tpl_2 after_called")
