  ...
  outputs = inputs @ {
    ...
    testshook = pkgs: {
      ...
      entry = "${pkgs.writeShellScript "run-tests" ''
        ...
        ${pkgs.lib.getExe pkgs.neovim-unwrapped} --headless --cmd "luafile $gitroot/test" +qall!
      ''}";
    };
          ...
          {buildLuarocksPackage}:
            buildLuarocksPackage {
              ...
              checkPhase = ''
                ...
                ${final.lib.getExe final.neovim-unwrapped} --headless --cmd "luafile $src/test" +qall!
